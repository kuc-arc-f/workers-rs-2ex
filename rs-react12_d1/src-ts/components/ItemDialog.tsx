  ...
  useEffect(() => {
    if (item && mode === 'edit') {
      setFormData({
        ...
        food_orange: item.food_orange,
        food_apple: item.food_apple,
        food_banana: item.food_banana,
        food_melon: item.food_melon,
        food_grape: item.food_grape,
        category_food: item.category_food,
        category_drink: item.category_drink,
      });
    } else {
      setFormData({
        title: '',
